...
const AdminPageListA = ({ searchParams }) => {
    ...
    useEffect(() => {
        const getUsers = async () => {
            ...
            setPageUsers(prevPageUsers => [...prevPageUsers, ...data]);
        };
    
        getUsers();
    }, [currentPage, setPageUsers, dataPerPage]);
                        ...
                        <section className=" border  rounded mx-auto">
                            <li className="list-group-item text-light  p-1 px-4" aria-current="true" style={{ background: '#4267b2' }}>
                                <div className='d-flex justify-content-between'>
                                    <h5 className='mt-2'> Admin Page List</h5>
                                    <button style={{ background: '#17a2b8' }} className='border-0 text-white shadow-sm rounded-1 rounded'><Link href='/Admin/admin_page_list/admin_page_list_create'>Admin Page Create</Link></button>
                                </div>
                            </li>
                            <Table responsive="lg">
                                <thead>
