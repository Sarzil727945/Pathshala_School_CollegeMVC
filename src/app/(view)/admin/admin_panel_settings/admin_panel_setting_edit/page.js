												...
												<div className="input-group mb-2">
													...
													<div className='d-flex mt-4'>
														...
														<div class=" border img_bg_card_header" style={{ width: '120px', height: '70px' }} >
															...
															{bodyBgimg ?
																<>
																	<Image className="w-100" src={URL.createObjectURL(bodyBgimg)} alt="Uploaded File" />
																	<button
...
<div>
  {selectedFile.map((preview, index) => (
	...
	<Image key={index} src={preview} alt={`Uploaded img ${index + 1}`} style={{ maxWidth: '100%', maxHeight: '300px', marginTop: '20px' }} />
	<button
