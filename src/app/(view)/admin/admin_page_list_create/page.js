                    ...
                    <div className='mb-3'>
                        <li className="list-group-item text-light  p-1 px-4 " aria-current="true" style={{ background: '#4267b2' }}>
                            <div className='d-flex justify-content-between mb-0'>
                                <h5 className='mt-2'> Admin Page Create
                                </h5>
                                <button style={{ background: '#17a2b8' }} className='border-0 text-white shadow-sm rounded-1 rounded'><Link href={`/Admin/admin_page_list/admin_page_list_all`}>Back To Admin Page List</Link></button>
                            </div>
                        </li>
